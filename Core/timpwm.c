...
void Tim1_PwmConfig(void)
{
    ...
    TIM1CH1MapInit.Pin        = MOTOR_DRIVE_PIN;
    TIM1CH1MapInit.Alternate  = LL_GPIO_AF_2; 
    LL_GPIO_Init(MOTOR_DRIVE_GPIO_PORT,&TIM1CH1MapInit);
    ...
    /* Configure CH2 */
    LL_TIM_OC_Init(TIM1,MOTOR_DRIVE_PWM_CH,&TIM_OC_Initstruct);
}
// 设置PWM占空比
